...
@section('content')
    ...
    <div class="message-content">
        ...
        <div class="highlight-box">
            <h3 style="color: #D9A600; margin-bottom: 15px;">📋 Lease Summary:</h3>
...
@section('disclaimer')
    ...
    <br><br>
    For inquiries, contact <a href="mailto:{{ $companyEmail }}" style="color: #D9A600 !important; text-decoration: none;">{{ $companyEmail }}</a>{{ !empty($companyPhone) ? ' or call ' . $companyPhone : '' }}.
    <br><br>
