    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Edit Mail Template</h1>
                </div>
                ...
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                    <div class="card box-shadow-0">
                        <div class="card-header">
                            <h4 class="card-title mb-1">Edit: {{ $mailTemplate->name }}</h4>
                            <p class="mb-2 text-muted">Update your email template settings and content</p>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('setting.mail-templates.update', $mailTemplate->slug) }}">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                id="name" name="name" value="{{ old('name', $mailTemplate->name) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('subject') is-invalid @enderror"
                                                id="subject" name="subject" value="{{ old('subject', $mailTemplate->subject) }}" 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                        ...
                                        placeholder="Brief description of when this template is used">{{ old('description', $mailTemplate->description) }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('variables') is-invalid @enderror"
                                        ...
                                        value="{{ old('variables', is_array($mailTemplate->variables) ? implode(', ', $mailTemplate->variables) : $mailTemplate->variables) }}" 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control summernote @error('body') is-invalid @enderror"
                                        id="body" name="body" rows="15">{{ old('body', $mailTemplate->body) }}</textarea>
                                    @error('body')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-save me-2"></i>Update Template
                                    </button>
