        ...
        <div class="card box-shadow-0">
            ...
            <div class="card-body">
                <form id="propertyThreeForm" method="post" action="{{ route('cms.property.three.update') }}"
                    ...
                    {{-- Primary Image --}}
                    <div class="form-group mb-3">
                        <label for="propertyThreeImage" class="form-label">Primary Image</label>
                        <input type="file" class="dropify form-control"
                            ...
                            name="image" id="propertyThreeImage" accept="image/*">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="file" class="form-control" name="images[]" id="propertyThreeImages"
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if ($existingVideo && file_exists(public_path($existingVideo)))
                            <div class="mb-2" id="propertyThreeVideoPreview">
                        ...
                        <input type="file" class="form-control" name="video" id="propertyThreeVideo"
...
<script>
    (function() {
        window.initPropertyThreeSection = function() {
            ...
            const imageInput = newForm.querySelector('#propertyThreeImage');
            if (imageInput) {
