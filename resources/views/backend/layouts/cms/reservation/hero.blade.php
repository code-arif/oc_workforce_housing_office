    ...
    <div class="col-lg-12">
        <div class="card box-shadow-0">
            <div class="card-header bg-light">
                <h4 class="card-title">Reservation Page - Hero Section</h4>
            </div>
            <div class="card-body">
                <form id="reservationHeroForm" method="post" action="{{ route('cms.reservation.hero.update') }}"
                    enctype="multipart/form-data">
                    @csrf

                    {{-- Title --}}
                    <div class="form-group mb-3">
                        <label for="reservation_title" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" id="reservation_title"
                    ...
                    {{-- Sub Title --}}
                    <div class="form-group mb-3">
                        <label for="reservation_sub_title" class="form-label">Sub Title</label>
                        <input type="text" class="form-control" name="sub_title" id="reservation_sub_title"
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary" type="submit" id="submitReservationHeroButton">
                            <span class="spinner-border spinner-border-sm d-none" id="reservationHeroSpinner"></span>
                            <span id="submitReservationBtnText">Save Changes</span>
                        </button>
                    </div>
                </form>
            </div>
...
<script>
    (function() {
        ...
        window.initReservationHeroSection = function() {

            const form = document.getElementById('reservationHeroForm');
            if (!form) {
            ...
            newForm.addEventListener('submit', async function(e) {
                ...
                const submitBtn = this.querySelector('#submitReservationHeroButton');
                const spinner = this.querySelector('#reservationHeroSpinner');
                const btnText = this.querySelector('#submitReservationBtnText');
        ...
        if (typeof window.initReservationHeroSection === 'function') {
            window.initReservationHeroSection();
        }
    })();
</script>
