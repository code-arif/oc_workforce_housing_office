    ...
    <div class="col-lg-12">
        <div class="card box-shadow-0">
            <div class="card-header bg-light">
                <h4 class="card-title">Home Page - Apartment & Dorm-Style Housing Section</h4>
            </div>
            <div class="card-body">
                <form id="apartmentForm" method="post"
                    action="{{ route('cms.home.apartment.section.update') }}" enctype="multipart/form-data">
                    @csrf

                    {{-- Title --}}
                    <div class="form-group mb-3">
                        <label for="apartment_title" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" id="apartment_title"
