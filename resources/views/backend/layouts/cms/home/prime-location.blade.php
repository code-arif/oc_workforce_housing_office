    ...
    <div class="col-lg-12">
        <div class="card box-shadow-0">
            <div class="card-header bg-light">
                <h4 class="card-title">Home Page - Prime Location Section</h4>
            </div>
            <div class="card-body">
                <form id="primeLocationForm" method="post"
                    action="{{ route('cms.home.prime.location.section.update') }}" enctype="multipart/form-data">
                    @csrf

                    {{-- Title --}}
                    <div class="form-group mb-3">
                        <label for="prime_location_title" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" id="prime_location_title"
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary" type="submit" id="submitButton">
                            <span class="spinner-border spinner-border-sm d-none" id="primeLocationSpinner"></span>
...
<script>
    (function() {
        ...
        window.initPrimeLocationSection = function() {

            const form = document.getElementById('primeLocationForm');
            if (!form) {
            ...
            newForm.addEventListener('submit', async function(e) {
                ...
                const spinner = this.querySelector('#primeLocationSpinner');
        ...
        if (typeof window.initPrimeLocationSection === 'function') {
            window.initPrimeLocationSection();
        }
    })();
</script>
