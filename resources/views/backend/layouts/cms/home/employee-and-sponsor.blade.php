    ...
    <div class="col-lg-12">
        <div class="card box-shadow-0">
            <div class="card-header bg-light">
                <h4 class="card-title">Home Page - Employee and Sponsor</h4>
            </div>
            <div class="card-body">
                <form id="employeeAndSponsorForm" method="post"
                    action="{{ route('cms.home.employee.and.sponsor.section.update') }}" enctype="multipart/form-data">
                    @csrf

                    {{-- Title --}}
                    <div class="form-group mb-3">
                        <label for="employee_and_sponsor_title" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" id="employee_and_sponsor_title"
                    ...
                    {{-- Sub Title --}}
                    <div class="form-group mb-3">
                        <label for="employee_and_sponsor_sub_title" class="form-label">Sub Title</label>
                        <input type="text" class="form-control" name="sub_title" id="employee_and_sponsor_sub_title"
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary" type="submit" id="submitButton">
                            <span class="spinner-border spinner-border-sm d-none" id="employeeSponsorSpinner"></span>
...
<script>
    (function() {
        ...
        window.initEmployeeAndSponsorSection = function() {

            const form = document.getElementById('employeeAndSponsorForm');
            if (!form) {
            ...
            newForm.addEventListener('submit', async function(e) {
                ...
                const spinner = this.querySelector('#employeeSponsorSpinner');
        ...
        if (typeof window.initEmployeeAndSponsorSection === 'function') {
            window.initEmployeeAndSponsorSection();
        }
    })();
</script>
