    ...
    <div class="col-lg-12">
        <div class="card box-shadow-0">
            <div class="card-header bg-light">
                <h4 class="card-title">Home Page - Who We Are</h4>
            </div>
            <div class="card-body">
                <form id="whoWeAre" method="post" action="{{ route('cms.home.who.we.are.section.update') }}"
                    enctype="multipart/form-data">
                    @csrf

                    {{-- Title --}}
                    <div class="form-group mb-3">
                        <label for="who_we_are_title" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" id="who_we_are_title"
                    ...
                    <div class="form-group mb-3">
                        <label for="who_we_are_description" class="form-label">Description</label>
                        <textarea class="form-control summernote" name="description" id="who_we_are_description"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="title" id="who_we_are_sub_title"
                            placeholder="Enter sub title" value="{{ $data->title ?? '' }}">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="title" id="who_we_are_sub_description"
                            placeholder="Enter sub description" value="{{ $data->title ?? '' }}">
                        <div class="invalid-feedback"></div>
                    </div>

                    <div class="form-group">
                        <button class="btn btn-primary" type="submit" id="submitWhoWeAreButton">
                            <span class="spinner-border spinner-border-sm d-none" id="whoWeAreSpinner"></span>
                            <span id="whoWeAreBtnText">Save Changes</span>
                        </button>
                    </div>
                </form>
            </div>
...
<script>
    (function() {
        ...
        window.initHousingOptionSection = function() {

            const form = document.getElementById('whoWeAre');
            if (!form) {
            ...
            newForm.addEventListener('submit', async function(e) {
                ...
                const submitBtn = this.querySelector('#submitWhoWeAreButton');
                const spinner = this.querySelector('#whoWeAreSpinner');
                const btnText = this.querySelector('#whoWeAreBtnText');
        ...
        if (typeof window.initHousingOptionSection === 'function') {
            window.initHousingOptionSection();
        }
    })();
</script>
