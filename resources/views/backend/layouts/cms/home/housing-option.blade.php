    ...
    <div class="col-lg-12">
        <div class="card box-shadow-0">
            <div class="card-header bg-light">
                <h4 class="card-title">Home Page - Housing Options</h4>
            </div>
            <div class="card-body">
                <form id="housingOptionForm" method="post" action="{{ route('cms.home.housing.option.section.update') }}"
                    enctype="multipart/form-data">
                    @csrf

                    {{-- Title --}}
                    <div class="form-group mb-3">
                        <label for="housing_option_title" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" id="housing_option_title"
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary" type="submit" id="submitHousingOptionButton">
                            <span class="spinner-border spinner-border-sm d-none" id="housingOptionSpinner"></span>
                            <span id="housingOptionBtnText">Save Changes</span>
                        </button>
                    </div>
                </form>
            </div>
...
<script>
    (function() {
        ...
        window.initHousingOptionSection = function() {
            ...
            const form = document.getElementById('housingOptionForm');
            if (!form) {
            ...
            newForm.addEventListener('submit', async function(e) {
                ...
                const submitBtn = this.querySelector('#submitHousingOptionButton');
                const spinner = this.querySelector('#housingOptionSpinner');
                const btnText = this.querySelector('#housingOptionBtnText');
