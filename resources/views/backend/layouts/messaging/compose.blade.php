                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-9 col-md-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body mail-compose-container">
                                <form>
                            ...
                            <div class="card-footer d-sm-flex">
                                <div class="btn-list">
                                    <a href="javascript:void(0)" class="btn btn-icon btn-white btn-svg fs-15 me-1"
                                        data-bs-toggle="tooltip" title="" data-bs-original-title="Attach">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                            enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                            <path
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-icon btn-white btn-svg fs-15"
                                        data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                            enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                            <path
                                                d="M20.5,6h-2H16V4.5c-0.0012817-1.380188-1.119812-2.4987183-2.5-2.5h-3C9.119873,2.0014648,8.0014648,3.119873,8,4.5V6H5.5C5.4998169,6,5.4996338,6,5.4993896,6H3.5C3.223877,6,3,6.223877,3,6.5S3.223877,7,3.5,7H5v12.5c0.0014648,1.380127,1.119873,2.4985352,2.5,2.5h9c1.380188-0.0012817,2.4987183-1.119812,2.5-2.5V7h1.5C20.776123,7,21,6.776123,21,6.5S20.776123,6,20.5,6z M9,4.5C9.0009155,3.671936,9.671936,3.0009155,10.5,3h3c0.828064,0.0009155,1.4990845,0.671936,1.5,1.5V6H9V4.5z M18,19.5c-0.0009155,0.828064-0.671936,1.4990845-1.5,1.5h-9c-0.828064-0.0009155-1.4990845-0.671936-1.5-1.5V7h2.5h7h0.0006104H18V19.5z" />
                                        </svg>
                                    </a>
                                </div>
                                <div class="btn-list ms-auto">
                                    <button class="btn btn-danger btn-space my-sm-0 my-1">Cancel</button>
                                    <button class="btn btn-primary btn-space my-sm-0 my-1">Send message</button>
                                </div>
                            </div>
                        </div>
                    </div>
