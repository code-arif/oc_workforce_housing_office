                    ...
                    <div class="col-lg-4 col-xl-3 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <a href="mail-compose.html" class="btn btn-outline-primary btn-block py-2">Compose</a>
                            </div>
                            <div class="card-body">
                                <ul class="nav1 nav-column flex-column br-7">
                                    <li class="nav-item1 mt-0">
                                        <a class="nav-link thumb" href="mail-inbox.html">
                            ...
                            <div class="card-body">
                                <div class="email-media">
                                    <div class="mt-0 d-sm-flex">
                                        <img class="me-2 rounded-circle avatar-xl" src="{{ asset('default/default_person.jpg') }}"
                                            alt="avatar">
                                        <div class="media-body">
                                            <div class="float-end d-none d-md-flex tx-8">
                                                <small class="me-2  border br-5 p-2" data-bs-toggle="tooltip"
                                                    title="" data-bs-original-title="Important">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                        <path
                                                            d="M21.9189453,10.1265259c0.0802612-0.546814-0.2979736-1.0551147-0.8447266-1.135376L15.4228516,8.164978l-2.5253906-5.1464844c-0.0909424-0.1569824-0.2214355-0.2873535-0.37854-0.3781128c-0.4960327-0.2866821-1.1306152-0.1170044-1.4173584,0.3790894L8.5771484,8.164978L2.9257812,8.9912109C2.7097168,9.0228882,2.5100098,9.1244507,2.3569946,9.2802734c-0.387146,0.3943481-0.3812256,1.0278931,0.0131226,1.4150391l4.0927734,4.0126953l-0.9658203,5.6640625c-0.0091553,0.0541992-0.013855,0.1090698-0.0139771,0.1641235c-0.0015259,0.5534058,0.4458618,1.0032959,0.9993286,1.0048218c0.163147-0.0002441,0.3237915-0.0404663,0.4677734-0.1171875L12,18.7539062l5.0488281,2.6689453c0.1951294,0.1035767,0.4190063,0.1396484,0.6367798,0.1025391c0.5441895-0.0928345,0.9100952-0.6091309,0.8173218-1.1533203l-0.9658203-5.6640625l4.09375-4.0137329C21.7861328,10.5414429,21.8872681,10.3421021,21.9189453,10.1265259z M16.6503906,14.1766968c-0.1170654,0.1148682-0.1706543,0.2796631-0.1435547,0.4414062l1.0097656,5.9208984l-5.2832031-2.7930298c-0.1463013-0.0761719-0.3204956-0.0761719-0.4667969,0L6.4833984,20.539978l1.0097046-5.921814c0.0271606-0.1617432-0.0264282-0.3265381-0.1435547-0.4414062L3.0702515,9.9814453l5.9121094-0.8642578C9.1456299,9.0927734,9.286499,8.9898682,9.359375,8.8417969L12,3.460022l2.640564,5.3817139c0.072876,0.1480713,0.2138062,0.2509766,0.3770142,0.2753906l5.9130859,0.8632812L16.6503906,14.1766968z" />
                                            ...
                                            <div class="media-title fw-bold mt-3">Sansa Stark <span
                                                    class="tx-13 fw-semibold">( sansastark@gmail.com )</span></div>
                                            <p class="mb-0"> to<span class="text-muted"> Emilie Benett (
                                                    emiliebenett@gmail.com )</span> </p>
                                ...
                                <div class="eamil-body mt-5">
                                    ...
                                    <p>Eirmod eos clita labore vero ea, Et clita ipsum lorem takimata est dolor clita, ut
                                        sea sed tempor amet. Duo consetetur invidunt elitr magna dolor dolor. dolor eos stet
                                        est sanctus ipsum sea sadipscing gubergren ut. Amet at ut voluptua nonumy, amet
                                        ipsum stet elitr.</p>
                                    <p>Dolor et dolor diam diam vero dolore tempor. Sea lorem sit et sea ut. Ipsum est justo
                                        consetetur eirmod kasd.</p>
                                    <p>Accusam gubergren consetetur sit eos sed tempor est stet kasd. Ipsum gubergren et ea
                                        clita accusam rebum, diam sed invidunt et dolor aliquyam sadipscing, sed eos
                                        sadipscing at sanctus et. Duo diam amet dolor stet..</p>
                                    <p class="mb-0">Thanking you Sir/Madam</p>
                                    <hr>
                                    <div class="email-attch">
                                        <div class="float-end">
                                            <a href="#"><i class="fe fe-download  border br-5 p-2  tx-18"
                                                    data-bs-toggle="tooltip" title=""
                                                    data-bs-original-title="Download"></i></a>
                                        </div>
                                        <p>3 Attachments.<a href="#" class="text-teritary"> View All Images</a></p>
                                        <div class="emai-img">
                                            <div class="d-sm-flex">
                                                <div class=" m-2">
                                                    <a href="#"><img class="wd-150 br-5 mb-2" height="200" width="250"
                                                            src="{{ asset('default/placeholder-image.avif') }}" alt="placeholder image"></a>
                                                    <h6 class="mb-3 mb-lg-0">1.jpg <small class="text-muted">12kb</small>
                                                    </h6>
                                                </div>
                                                <div class=" m-2">
                                                    <a href="#"><img class="wd-150 br-5 mb-2" height="200" width="250"
