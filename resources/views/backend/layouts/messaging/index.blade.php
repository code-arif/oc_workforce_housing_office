                    ...
                    <div class="col-md-12 col-lg-4 col-xl-3">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <a href="{{ route('messaging.compose') }}"
                                    class="btn btn-block btn-outline-primary py-2">Compose</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <li class="nav-item1">
                                        <a class="nav-link thumb" href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                <path
                                                    d="M17,9V7c0-2.7614136-2.2385864-5-5-5S7,4.2385864,7,7v2c-1.6561279,0.0018311-2.9981689,1.3438721-3,3v7c0.0018311,1.6561279,1.3438721,2.9981689,3,3h10c1.6561279-0.0018311,2.9981689-1.3438721,3-3v-7C19.9981689,10.3438721,18.6561279,9.0018311,17,9z M8,7c0-2.2091675,1.7908325-4,4-4s4,1.7908325,4,4v2H8V7z M19,19c-0.0014038,1.1040039-0.8959961,1.9985962-2,2H7c-1.1040039-0.0014038-1.9985962-0.8959961-2-2v-7c0.0014038-1.1040039,0.8959961-1.9985962,2-2h0.5h9h0.0006104H17c1.1040039,0.0014038,1.9985962,0.8959961,2,2V19z" />
                                            </svg>
                                            Trash Bin
                                        </a>
                                    </li>
                                ...
                                <ul class="nav1 nav-column flex-column br-7 mt-3">
                                    <li class="nav-item1 mt-0">
                                        <a class="nav-link thumb" href="mail-settings.html">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                <path
                                ...
                                <div class="inbox-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-inbox table-hover text-nowrap mb-0">
                                            <tbody>
                                                <tr class="clickable-row" data-href="{{ route('messaging.read') }}">
                                                    ...
                                                    <td class="inbox-small-cells"><i class="fa fa-star text-warning"></i>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="view-message view-message">Somebody requested a new password
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="view-message view-message">Password successfully changed
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="view-message view-message">Welcome to the Drupal Community
                                                    </td>
                                                ...
                                                <tr class="unread">
                                                    ...
                                                    <td class="view-message">Alireza: Nokia Networks, System Group and
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="view-message view-message">Your account was recently logged
                                                        into</td>
                                                    <td class="view-message text-end fw-semibold">March 14</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="inbox-small-cells"><i
                                                            class="fa fa-bookmark text-danger"></i></td>
                                                    <td class="view-message dont-show fw-semibold">Laura Gaffin, S P N
                                                    </td>
                                                    <td class="view-message">Your Website On Google (Higher Rankings Are
                                                        Better)</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="view-message">Submit Your Website to the AddMe Business
                                                        Directory</td>
                                                    <td class="view-message text-end fw-semibold">August 10</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="view-message view-message">Forget Google AdWords: Un-Limited
                                                        Clicks fo</td>
