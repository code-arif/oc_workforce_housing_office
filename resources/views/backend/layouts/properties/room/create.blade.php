                ...
                <div class="page-header">
                    ...
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item " aria-current="page"><a href="{{ route('rooms.list') }}">Rooms</a>
                            </li>
                                    ...
                                    <div class="row modal-body">
                                        ...
                                        <div class="col-12 col-lg-8 col-xl-8 mb-3">
                                            <div class="row">
                                                ...
                                                <!-- Gender Designation -->
                                                <div class="col-12 mb-3">
                                                    <label for="gender_designation" class="form-label">Gender
                                        ...
                                        <div class="col-12 col-lg-4 col-xl-4 mb-3">
                                            ...
                                            <div id="bed-container" class="border p-3" style="background-color: #f8f9fa;">
                                                ...
                                                <div class="bed-item-empty">No beds added. Click "Add Bed" to start adding
                                                    beds.</div>
                                            </div>
                                        </div>
                                    </div>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            // Load beds from old input if validation failed
        ...
        function removeBed(btn) {
            ...
            if (bedContainer.children.length === 0) {
                bedContainer.innerHTML =
                    '<div class="bed-item-empty">No beds added. Click "Add Bed" to start adding beds.</div>';
            }
        }
