        ...
        <div class="side-app">
            <div class="main-container container-fluid">
                ...
                <div class="row">
                                ...
                                <div class="timeline-steps">
                                    ...
                                    <div class="timeline-step">
                                        <div class="timeline-content">
                                            ...
                                            <p class="text-muted small">System will read and convert your document to
                                                editable format</p>
                                        </div>
                                    </div>
                                    <div class="timeline-step">
                                        <div class="timeline-content">
                                            ...
                                            <p class="text-muted small">Drag and drop dynamic placeholders into the document
                                            </p>
                                        </div>
                                    </div>
                                    <div class="timeline-step">
                    ...
                    <div class="col-lg-8">
                        <form action="{{ route('lease-templates.store') }}" method="POST" enctype="multipart/form-data"
                            id="uploadForm">
                            @csrf
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <small class="form-text text-muted">
                                                    <i class="fas fa-info-circle"></i> Give your template a clear,
                                                    descriptive name
                                                </small>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="upload-zone" id="uploadZone">
                                        <div class="upload-zone-content text-center" style="font-size: 0.9rem;">
                                            <div class="upload-icon-wrapper mb-2" style="font-size: 1.5rem;">
                                                <i class="fas fa-cloud-upload-alt"></i>
                                            </div>

                                            <h4 class="upload-title mb-1" style="font-size: 1.1rem;">Drop your file here
                                            </h4>
                                            <p class="upload-subtitle mb-2" style="font-size: 0.85rem;">or click to browse
                                            </p>

                                            <div class="upload-formats mb-2">
                                                <span class="format-badge" style="font-size: 0.8rem;">
                                                    <i class="fas fa-file-pdf me-1"></i>Only PDF
                                                </span>
                                            </div>
