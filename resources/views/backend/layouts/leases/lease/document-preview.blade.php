...
document.addEventListener('DOMContentLoaded', function() {
        ...
        loadingTask.promise.then(function(pdf) {
            ...
            for (let pageNum = 1; pageNum <= totalPages; pageNum++) {
                renderPromise = renderPromise.then(() => {
                    return renderPage(pdf, pageNum, totalPages, placeholdersByPage[pageNum] || [], signaturesByPage[pageNum] || []);
                });
            }
    ...
    function renderPage(pdf, pageNum, totalPages, pagePlaceholders, pageSignatures) {
