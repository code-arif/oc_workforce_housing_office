            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('units.list') }}" class="slide-item">Units</a></li>
                        <li><a href="{{ route('rooms.list') }}" class="slide-item">Rooms</a></li>
                        <li><a href="{{ route('beds.list') }}" class="slide-item">Beds</a></li>
