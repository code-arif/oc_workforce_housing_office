...
class TenantPartialPaymentController extends Controller
{
    use ApiResponse;

    protected $stripeService;

    public function __construct(V2StripePartialPaymentService $stripeService)
    {
    ...
    /**
     * Create Stripe Payment Intent for custom Payment Element (Card + ACH) supporting partial payment
     */
