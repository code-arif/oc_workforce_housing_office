    ...
    public function createCheckoutSession(array $invoiceIds, int $tenantId, string $paymentMethodType = 'card'): array
    {
        ...
        try {
            ...
            $sessionParams = [
                ...
                'mode' => 'payment',
                'success_url' => $successUrl . '?session_id={CHECKOUT_SESSION_ID}&is_multi_payment=1&payment_method_type=' . $paymentMethodType . '&invoice_ids=' . $invoiceIdsStr . '&status=success',
                'cancel_url' => $cancelUrl . '&is_multi_payment=1&payment_method_type=' . $paymentMethodType . '&invoice_ids=' . $invoiceIdsStr . '&status=cancel',
