    ...
    public function createCheckoutSession($invoiceId, $tenantId, ?float $amountToPay = null, string $paymentMethodType = 'card'): array
    {
        ...
        try {
            ...
            $sessionParams = [
                ...
                'mode' => 'payment',
                'success_url' => $successUrl . '?session_id={CHECKOUT_SESSION_ID}&payment_method_type=' . $paymentMethodType . '&invoice_ids=&status=success',
                'cancel_url' => $cancelUrl . '&payment_method_type=' . $paymentMethodType . '&invoice_ids=&status=cancel',
